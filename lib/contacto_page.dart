...
class ContactoPage extends StatelessWidget {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildFormSection(isDesktop, isEn),
    ...
    final methods = [
      {
        ...
        'detail': '+54 341 336 3551',
        'url': 'https://wa.me/5493413363551',
      },
      {
        'icon': FontAwesomeIcons.envelope,
        'title': 'Email',
        'subtitle': isEn ? 'For detailed inquiries' : 'Para consultas detalladas',
        'detail': 'dominguezmariajimena@gmail.com',
        'url': 'mailto:dominguezmariajimena@gmail.com',
      },
      {
        'icon': FontAwesomeIcons.instagram,
        'title': 'Instagram',
        'subtitle': isEn ? 'Follow my work' : 'Sigue mi trabajo',
        'detail': '@programacionjj',
        'url': 'https://www.instagram.com/programacionjj',
      },
    ];
  ...
  Widget _buildFormSection(bool isDesktop, bool isEn) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          isEn ? 'Or send us a message directly' : 'O envíanos un mensaje directamente',
          style: GoogleFonts.inter(
            fontSize: 13,
            fontWeight: FontWeight.w600,
            color: AppColors.muted,
